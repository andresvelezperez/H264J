...
public class AVFrame {
    ...
    /**
     * \
     * pointer to the picture planes.\ This might be different from the first
     * allocated byte\ - encoding: \ - decoding: \
     */
     ...
     * get_buffer/release_buffer.\ This isn't used by libavcodec unless the
     * default get/release_buffer() is used.\ - encoding: \ - decoding: \
     */
    public int[][] base = new int[4][]; //uint8_t *base[4];\
    /**
     * \
     * 1 -> keyframe, 0-> not\ - encoding: Set by libavcodec.\ - decoding: Set
     * by libavcodec.\
     */
    public int key_frame;
    /**
     * \
     * Picture type of the frame, see ?_TYPE below.\ - encoding: Set by
     * libavcodec. for coded_picture (and set by user for input).\ - decoding:
     * Set by libavcodec.\
     */
     ...
     * shown to user)\ If AV_NOPTS_VALUE then frame_rate = 1/time_base will be
     * assumed.\ - encoding: MUST be set by user.\ - decoding: Set by
     * libavcodec.\
     */
    public long pts;
    /**
     * \
     * picture number in bitstream order\ - encoding: set by\ - decoding: Set by
     * libavcodec.\
     */
    public int coded_picture_number;
    /**
     * \
     * picture number in display order\ - encoding: set by\ - decoding: Set by
     * libavcodec.\
     */
    public int display_picture_number;
    /**
     * \
     * quality (between 1 (good) and FF_LAMBDA_MAX (bad)) \ - encoding: Set by
     * libavcodec. for coded_picture (and set by user for input).\ - decoding:
     * Set by libavcodec.\
     */
    public int quality;
    /**
     * \
     * buffer age (1->was last buffer and dint change, 2->..., ...).\ Set to
     * INT_MAX if the buffer has not been used yet.\ - encoding: unused\ -
     * decoding: MUST be set by get_buffer().\
     */
    public int age;
    /**
     * \
     * is this picture used as reference\ The values for this are the same as
     * the MpegEncContext.picture_structure\ variable, that is 1->top field,
     * 2->bottom field, 3->frame/both fields.\ Set to 4 for delayed,
     * non-reference frames.\ - encoding: unused\ - decoding: Set by libavcodec.
    ...
    /**
     * \
     * mbskip_table[mb]>=1 if MB didn't change\ stride= mb_width =
     * (width+15)>>4\ - encoding: unused\ - decoding: Set by libavcodec.\
     */
    ...
    /**
     * \
     * macroblock type table\ mb_type_base + mb_width + 2\ - encoding: Set by
     * user.\ - decoding: Set by libavcodec.\
     */
    public int mb_type_offset; //uint32_t *mb_type;\
    /**
     * \
     * log2 of the size of the block which a single vector in motion_val
     * represents: \ (4->16x16, 3->8x8, 2-> 4x4, 1-> 2x2)\ - encoding: unused\ -
     * decoding: Set by libavcodec.\
     */
    public int motion_subsample_log2; //uint8_t motion_subsample_log2;\
    /**
     * \
     * for some private data of the user\ - encoding: unused\ - decoding: Set by
     * user.\
     */
    public Object opaque; //void *opaque;\
    /**
     * \
     * error\ - encoding: Set by libavcodec. if flags&CODEC_FLAG_PSNR.\ -
     * decoding: unused\
     */
     ...
     * encoding: Set by the one who allocates it.\ - decoding: Set by the one
     * who allocates it.\ Note: User allocated (direct rendering) & internal
     * buffers cannot coexist currently.\
     */
    public int type;
    /**
     * \
     * When decoding, this signals how much the picture must be delayed.\
     * extra_delay = repeat_pict / (2*fps)\ - encoding: unused\ - decoding: Set
     * by libavcodec.\
     */
    ...
    /**
     * \
     * The content of the picture is interlaced.\ - encoding: Set by user.\ -
     * decoding: Set by libavcodec. (default 0)\
     */
    public int interlaced_frame;
    /**
     * \
     * If the content is interlaced, is top field displayed first.\ - encoding:
     * Set by user.\ - decoding: Set by libavcodec.\
     */
     ...
     * encoding: ??? (no palette-enabled encoder yet)\ - decoding: Set by
     * libavcodec. (default 0).\
     */
    public int palette_has_changed;
    /**
     * \
     * codec suggestion on buffer type if != 0\ - encoding: unused\ - decoding:
     * Set by libavcodec. (before get_buffer() call)).\
     */
    ...
    /**
     * \
     * motion reference frame index\ the order in which these are stored can
     * depend on the codec.\ - encoding: Set by user.\ - decoding: Set by
     * libavcodec.\
     */
     ...
     * PTS but can be anything). \ The user sets AVCodecContext.reordered_opaque
     * to represent the input at\ that time,\ the decoder reorders values as
     * needed and sets AVFrame.reordered_opaque\ to exactly one of the values
     * provided by the user through AVCodecContext.reordered_opaque \ -
     * encoding: unused\ - decoding: Read by user.\
     */
    public long reordered_opaque; //int64_t reordered_opaque;\
    /**
     * \
     * hardware accelerator private data (FFmpeg allocated)\ - encoding: unused\
     * - decoding: Set by libavcodec\
     */
     ...
     * decoder\ - encoding: unused\ - decoding: Read by user.\
     */
    ...
    public int pic_id;
    /** < h264 pic_num (short -> no wrap version of pic_num, pic_num &
     * max_pic_num; long -> long_pic_num)
     */
