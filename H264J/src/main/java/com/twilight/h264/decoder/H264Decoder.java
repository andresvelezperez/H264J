...
public class H264Decoder {
    ...
    /**
     * Codec has a nonzero delay and needs to be fed with NULL at the end to get
     * the delayed data. If this is not set, the codec is guaranteed to never be
     * fed with NULL data.
     */
    public static final int CODEC_CAP_DELAY = 0x0020;

    /**
     * Name of the codec implementation. The name is globally unique among
     * encoders and among decoders (but an encoder and a decoder can share the
     * same name). This is the primary way to find a codec from the user
     * perspective.
     */
