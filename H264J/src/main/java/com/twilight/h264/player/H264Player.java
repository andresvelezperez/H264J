...
public class H264Player implements Runnable {
    ...
    public static void main(String[] args) {
        if (args.length < 1) {
            System.out.println("Usage: com.twilight.h264.player.H264Player <.h264 raw file>\n");
            return;
        }
        ...
        new H264Player(inputStream, args[0]);
    }

    public H264Player(InputStream inputStream, String fileName) {
